<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Temp_ShowRoom.Contact" %>
...
<body>
    ...
    <div class="banner-buying">
        <div class="container">
            <h1 class="conth1 wow flipInX">Contact <span style="color: green; border-bottom: 4px solid green">US</span></h1>
    ...
    <div class="container">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 wow fadeInLeft" style="border-right: dotted 1px black">
            <form role="form">
                <div class="form-group">
                    ...
                    <label class="control-label" for="exampleInputEmail">Phone Number</label>
                    <input type="email" class="form-control" id="Email3" placeholder="Phone Number">
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 wow fadeInRight">
            <div class="form-group">
